    ...
    : QDialog(parent), m_system(system), m_branch_watch(branch_watch), m_code_widget(code_widget)
{
  ...
  // Controls Toolbar
  m_control_toolbar = new QToolBar(this);
  {
    // Tool Controls
    m_btn_start_pause = new QPushButton(tr("Start Branch Watch"), this);
    ...
    m_btn_clear_watch = new QPushButton(tr("Clear Branch Watch"), this);
    ...
    m_btn_path_was_taken = new QPushButton(tr("Code Path Was Taken"), this);
    ...
    m_btn_path_not_taken = new QPushButton(tr("Code Path Not Taken"), this);
    ...
    auto* const group_box = new QGroupBox(tr("Tool Controls"), this);
  ...
  }
  {
    ...
    const auto routine = [this, layout](const QString& text, const QString& tooltip, int row,
      ...
      auto* const check_box = new QCheckBox(text, this);
    ...
    auto* const group_box = new QGroupBox(tr("Branch Type"), this);
    group_box->setLayout(layout);
    group_box->setAlignment(Qt::AlignHCenter);
  ...
  }
  {
    ...
    const auto routine = [this, layout](const QString& placeholder_text, int row, int column,
      ...
      auto* const line_edit = new QLineEdit(this);
    ...
    auto* const group_box = new QGroupBox(tr("Origin and Destination"), this);
    group_box->setLayout(layout);
    group_box->setAlignment(Qt::AlignHCenter);
  ...
  }
  {
    ...
    auto* const group_box = new QGroupBox(tr("Condition"), this);
    group_box->setLayout(layout);
    group_box->setAlignment(Qt::AlignHCenter);
  ...
  {
    // Misc. Controls
    m_btn_was_overwritten = new QPushButton(tr("Branch Was Overwritten"), this);
    ...
    m_btn_not_overwritten = new QPushButton(tr("Branch Not Overwritten"), this);
    ...
    m_btn_wipe_recent_hits = new QPushButton(tr("Wipe Recent Hits"), this);
    ...
    auto* const group_box = new QGroupBox(tr("Misc. Controls"), this);
    group_box->setLayout(layout);
    group_box->setAlignment(Qt::AlignHCenter);
  ...
  m_mnu_toolbar_visibility = new QMenu(this);
  {
    const auto routine = [this](const QString& text, QAction* toolbar_action) {
      auto* const menu_action = m_mnu_toolbar_visibility->addAction(
          text, [toolbar_action](bool enabled) { toolbar_action->setVisible(enabled); });
  ...
  // Menu Bar
  auto* const menu_bar = new QMenuBar(this);
  menu_bar->setNativeMenuBar(false);
  {
    auto* const menu = new QMenu(tr("&File"), this);
  ...
  {
    auto* const menu = new QMenu(tr("&Tool"), this);
    ...
    menu->addMenu(m_mnu_toolbar_visibility)->setText(tr("&Toolbar Visibility"));
